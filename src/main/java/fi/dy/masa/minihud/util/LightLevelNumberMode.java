...
{
    NONE    ("none",    "purityhud.label.light_level_number_mode.none"),
    BLOCK   ("block",   "purityhud.label.light_level_number_mode.block"),
    SKY     ("sky",     "purityhud.label.light_level_number_mode.sky"),
    BOTH    ("both",    "purityhud.label.light_level_number_mode.both");
